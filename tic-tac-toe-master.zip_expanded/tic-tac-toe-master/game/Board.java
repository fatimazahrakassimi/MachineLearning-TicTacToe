...
public class Board extends JPanel {
  ...
  public Board(String player, boolean iscomputer, boolean isplayerfirst,
    ...
    if (isComputer) {
      ...
      System.out.println(getTurn() + " Premier joueur");
      System.out.println(getPlayLeft() + " le reste des noeuds");
    } else {
      System.out.println(getTurn() + " Deuxième joueur");
      System.out.println(getPlayLeft() + " Le reste des noeuds");
    }
  }
  ...
  public void generalTestWinner() {
    if (isComputer) {
      if (currentState.checkWinnerBest(playLeft) == -1) {
        displayEndingMessage("Gagnant", "L'humain gagne!");
      } else if (currentState.checkWinnerBest(playLeft) == -0) {
        displayEndingMessage("Perdant!", "Vous avez échoué!");
      } else if (currentState.checkWinnerBest(playLeft) == 1) {
        displayEndingMessage("Gagnat!", "La machine gagne!");
      }
    } else {
      if (currentState.checkWinnerBest(playLeft) == -1) {
        displayEndingMessage("Gagnant!", "Premier joueur gagne!");
      } else if (currentState.checkWinnerBest(playLeft) == -0) {
        displayEndingMessage("Perdant!", "Vous avez échoué!");
      } else if (currentState.checkWinnerBest(playLeft) == 1) {
        displayEndingMessage("Gagnant!", "Deuxième joueur gagne!");
      }
    }
  }
